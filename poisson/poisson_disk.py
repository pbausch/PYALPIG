...
def sample_poisson_uniform(width, height, r, k):
    ...
    def generate_random_around(arg1, r):
        (x, y) = arg1
        rr = uniform(r, 2 * r)
        rt = uniform(0, 2 * pi)
...
def sample_poisson(width, height, r_grid, k):
    ...
    grid = ListGrid2D(int_point_2d((ceil(width / cell_size), ceil(height / cell_size))))
